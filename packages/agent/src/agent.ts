// @jawere/agent — Stateful Agent class
...
import { streamSimple, EventStream } from "@jawere/ai";
...
export class Agent {
  ...
  public onPayload?: (payload: unknown) => void;
  public onResponse?: (response: unknown) => void;
  ...
  public thinkingBudgets?: Record<string, number>;
  /** Preferred transport forwarded to the stream function. */
  public transport: "sse" | "websocket" | "auto";
  ...
  constructor(options: AgentOptions = {}) {
    ...
    this.streamFn = options.streamFn ?? streamSimple as any;
  ...
  async prompt(input: string, images?: any[]): Promise<void>;
  async prompt(
