...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@jawere/agent";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@jawere/ai/compat";
import { completeSimple } from "@jawere/ai/compat";
import {
	convertToLlm,
