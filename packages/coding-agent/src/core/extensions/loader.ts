...
import * as _bundledPiAgentCore from "@jawere/agent";
import * as _bundledPiAiCompat from "@jawere/ai/compat";
import * as _bundledPiAiOauth from "@jawere/ai/oauth";
import type { KeyId } from "@jawere/tui";
import * as _bundledPiTui from "@jawere/tui";
...
function getAliases(): Record<string, string> {
	...
	const piAgentCoreEntry = resolveWorkspaceOrImport("agent/dist/index.js", "@jawere/agent");
	const piTuiEntry = resolveWorkspaceOrImport("tui/dist/index.js", "@jawere/tui");
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	const piAiCompatEntry = resolveWorkspaceOrImport("ai/dist/compat.js", "@jawere/ai/compat");
