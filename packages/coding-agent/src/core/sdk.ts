...
import { Agent, type AgentMessage, type ThinkingLevel } from "@jawere/agent";
import { clampThinkingLevel, type Message, type Model, streamSimple } from "@jawere/ai/compat";
 ...
 *
 * // With explicit model
 * import { getModel } from '@jawere/ai';
 * const { session } = await createAgentSession({
