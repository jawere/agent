...
const FILES_LIST_FILE = '.codebase/files.txt'; // newline-separated list for @-autocomplete
...
/** Load flat file list from scanner output (for @-tag autocomplete). */
...
async function scanCodebase(
  ...
  // 5b. Write flat file list for @-tag autocomplete
