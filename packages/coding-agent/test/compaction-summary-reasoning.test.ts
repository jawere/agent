...
import type { AssistantMessage, Model } from "@jawere/ai";
...
vi.mock("@jawere/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@jawere/ai/compat")>();
	return {
		...actual,
